...
$width = 199;
$background_color = 'f8f8f8'; // background-color of the chart...
$text_color = '222222'; // text-color.
...
for ($i = 0; $i < count($label); $i++) 
{
	...
	if ($show_text) $label_output = $label_output.codificador($label[$i]).' ';
