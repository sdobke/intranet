...
$sqlen = "SELECT * FROM intranet_encuesta_datos WHERE del = 0";
...
if (isset($_GET['func']) || isset($_POST['func'])){
	$nombre = $_POST['nombre'];
	$sql_mod = "UPDATE intranet_encuesta_datos SET titulo = '".$nombre."' WHERE id = 1";
				...
				<div class="container">
					...
					<div class="left w100" >						
						...
						<div class="contenidos" align="center" style="width:500px; margin:auto; padding:50px; text-align:left">
                        	<strong>Nueva Encuesta</strong><br /><br />
