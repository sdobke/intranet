...
// Se quitó la restricción de mostrar solamente novedades de home
...
$slider_sql = "SELECT inov.id AS id, inov.id != 'ddd' AS tipo, inov.fecha AS fecha, inov.hora AS hora, inov.titulo AS titulo, inov.texto AS texto, inov.video AS video 
          ...
          INNER JOIN " . $_SESSION['prefijo'] . "fotos AS fot

            ON fot.item = inov.id AND fot.tipo = 7

            WHERE 1 AND il.tipo = 7 " . $sql_restric . " AND inov.home = 1 AND inov.del = 0 AND inov.activo = 1 AND fot.ppal = 1
...
?>
  ...
  <div class="row" id="slider-container">
    ...
    <div class="col">
      ...
      <div id="slider" class="left slickslider">
        ...
        ?>
          ...
          <div class="fotoslide">
            ...
            <img src="<?php echo $link_foto; ?>" alt="<?php echo $text_default ?>" />

            <div class="textoslide">

              <div class="tsinterior">

                <h2><a href="<?php echo $link; ?>"><?php echo txtcod($noti_titulo); ?></a></h2>
