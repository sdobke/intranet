...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "js/openwysiwyg/images/";
		
		// Popups Directory
		this.PopupsDir = "js/openwysiwyg/popups/";
		
		// CSS Directory File
		this.CSSFile = "js/openwysiwyg/styles/wysiwyg.css";		
	...
	"forecolor":      ['ForeColor',            'Color de Texto',      	'forecolor.gif',          'forecolor_on.gif'],
