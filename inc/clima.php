...
if($proveedor == 1){
	require_once($pre_url.'includes/clima/google_weather_api.php');
}
if($proveedor == 2){
	//require_once('../includes/clima/pxweather/pxweather.class.php');
}
...
if($proveedor == 1){
	...
	*/
	if(!file_exists($dir_dest) || $dir_dest == $pre_url.'includes/clima/iconos/'){
		$dir_dest = $pre_url.'includes/clima/iconos/mostly_cloudy.gif';
	}
}

if($proveedor == 2){
	echo '<a href="http://weather.com" target="_blank"><img src="'.$pre_url.'includes/clima/iconos/TWClogo_31px.png" alt="weather.com" title="weather.com" border="0" style="border:none" /></a>&nbsp;';
}

if($proveedor == 2){
	require_once($pre_url.'includes/clima/weather/index.php');
}
...
echo ' | <a href="'.$pre_url.'clima.php">Pron&oacute;stico extendido</a> ';
