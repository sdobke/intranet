...
if ($contar >= 1) {
	...
	$cump_sql = "SELECT emp.id, emp.nombre, emp.apellido, emp.empresa, emp.area, emp.puesto AS puesto, emp.email, emp.interno, emp.".$campo_ani." ";
...
?>
	...
	<div id="<?php echo $idnomb;?>" class="seccion">
		...
		<div class="row widget">
			...
			if($empleCumple == ''){
				...
				echo '<div class="col">No hay '.$titu_widg.' el día de hoy.</div>';
			...
			?>
				...
				<div class="vermas">
					...
					<div class="col"><a href="javascript:void()" data-bs-toggle="modal" data-bs-target="#<?php echo $modalnomb;?>">Próximos <?php echo ucfirst($titu_widg);?> (<?php echo $contar; ?>) >> </a></div>
			...
			<?php
				...
				while ($cump_emp = mysqli_fetch_array($cump_result)) {
					...
					$empleCumple .= '<div class="col-xs-4 col-sm-4 col-lg-3" style="float:left">' . traerEmpleado($cump_emp, $multiemp, $campo_ani) . '</div>';
		...
		<div class="modal-dialog modal-xl modal-fullscreen-xl-down">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h5 class="modal-title" id="exampleModalLabel">Próximos <?php echo ucfirst($titu_widg);?></h5>
