...
// VAPID appPublic key
const strAppPublicKey  = 'BJWgy3AK2QAvjdPGZW59-e3aCwcIV_7IrdUQdEEfqmYhRJuyW5rX-trTY90RMLlWFbOPCell2NAHRoijVPiTccc';
// URL to save subscription on server via Fetch API
const strSubscriberURL = 'https://bercovich.intranet.com.ar/backend/push_notifications/PNSubscriber.php';
// default Notification Title if not pushed by server
const strDefTitle      = 'Bercovich';
