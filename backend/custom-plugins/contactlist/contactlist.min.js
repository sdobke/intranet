...
;(function(b,k,l,e){var d=function(a,b){arguments.length&&this._init(a,b)};d.prototype={defaults:{contactListClass:"thumbnails",scrollTimeout:100,scrollOptions:{duration:500,easing:"swing"},showFilters:!0,filterPlaceholder:"Buscar...",filterContainerClass:"search-form",filterInputClass:"search-query",filterFunction:null},_init:function(a,c){this.element=b(a);this.options=b.extend({},this.defaults,c,this.element.data());this._groups=[];this._container=this._build();this._listen();return this},_build:function(){var a=
