					...
					<div id="content-inner">
						...
						<section id="main" class="clearfix">
							<div id="main-header" class="page-header">
								...
								<h1 id="main-heading">
									<?PHP echo ucwords(txtcod($nombredet)); ?> <span>Secciones por meses (Tiendas y Locales)</span>
								</h1>
							</div>
							<div id="main-content">
								<div class="row-fluid">
								...
								<div class="row-fluid">
									<div class="widget">
										...
										<div class="widget-content table-container">
											<?PHP
											$sql2 = "
							SELECT COUNT(acc.id) AS accesos, sec.nombre AS nombre, sec.id AS secid
								...
								WHERE (DATE(acc.fecha) BETWEEN '$fechadesde' AND '$fechahasta')
							...
							"; //LIMIT 1,1000";
								 ...
								 SELECT COUNT(acc.id) AS accesos, sec.nombre AS nombre, sec.id AS secid
									...
									INNER JOIN intranet_empleados AS emp ON emp.id = acc.empleado
									INNER JOIN intranet_areas AS are ON emp.area = are.id
										WHERE (DATE(acc.fecha) BETWEEN '" . date('Y-m', $conso_mes) . "-01' AND '" . date('Y-m', $conso_mes) . "-31')
									GROUP BY acc.seccion
									ORDER BY accesos DESC
									"; //LIMIT 1,1000";
							...
							";
								...
								";
												...
												<div style="overflow: hidden; width:950px" id="marco_grafico">
													<!--[if !IE]><!-->
													<div id="secmesesofi" style="height:650px; position:relative; top:-110px; left:-110px; width:950px"></div>
													<!--<![endif]-->
													<!--[if IE]>
