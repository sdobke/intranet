                                            ...
                                            echo '<table width="100%" class="reservas">
                                                <tr class="tabtit">
                                                  ...
                                                  if($modo == 0){
													  ...
													  echo '<td width="110">Lunes</td>';
													  echo '<td width="110">Martes</td>';
													  echo '<td width="110">Mi&eacute;rcoles</td>';
													  echo '<td width="110">Jueves</td>';
													  echo '<td width="110">Viernes</td>';
													  /*
